      ...
      <table id="example1" class="table table-bordered table-striped">
        ...
        <tbody>
          ...
          <tr>
              ...
              <td><a class="btn btn-sm btn-outline-secondary" href="{{route('admin.brand.edit',['id' => $item->id])}}"><i class="fa-solid fa-pen-to-square"></i></a></td>
              <td><a class="btn btn-sm btn-outline-secondary" href="{{route('admin.brand.destroy',['id' => $item->id])}}"><i class="fa-solid fa-trash"></i></a></td>
          </tr>
          @endforeach    
        </tbody>
      </table>
